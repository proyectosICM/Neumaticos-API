...
import com.icm.tiremanagementapi.domain.EmailFileDTO;
import com.icm.tiremanagementapi.repositories.IEmailRepository;
...
public class MailController {
    ...
    public ResponseEntity<?> receiveRequestEmail(@RequestBody EmailDTO emailDTO){
        ...
        emailRepository.sendEmail(emailDTO.getToUser(), emailDTO.getSubject(), emailDTO.getMessage());
    ...
    public ResponseEntity<?> receiveRequestEmailWithFile(@ModelAttribute EmailFileDTO emailFileDTO){
        ...
        try {
            ...
            emailRepository.sendEmailWithFile(emailFileDTO.getToUser(), emailFileDTO.getSubject(), emailFileDTO.getMessage(), file);
